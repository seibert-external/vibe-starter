...
const columns: Column<PageRow>[] = [
  {
    ...
    label: "Page",
    render: (v) => (
      <code className="text-sds-pine-green-600 text-xs font-medium">
        {String(v)}
      </code>
    ),
  },
  ...
  { key: "avgDuration", label: "Avg. Duration", align: "right" },
  {
    ...
    render: (v) => {
      ...
      const label =
        v === "healthy" ? "Healthy" : v === "warning" ? "Warning" : "Error";
      return (
        <StatusCell
          label={label}
          variant={variant}
  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-6 p-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-sds-rich-black text-2xl font-bold">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
          <CardHeader className="mb-4">
            ...
            <span className="text-sds-gray-400 text-xs">Jan – Dec 2025</span>
          </CardHeader>
          <AreaChart
            data={revenueData}
            height={240}
            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-4">
                <div className="flex items-center gap-1.5">
                  <div className="bg-sds-pine-green-600 size-2.5 rounded-full" />
                  <span className="text-sds-gray-400 text-xs">This month</span>
                </div>
                <div className="flex items-center gap-1.5">
                  <div className="bg-sds-apple-green size-2.5 rounded-full" />
                  <span className="text-sds-gray-400 text-xs">Last month</span>
                </div>
              </div>
            </div>
          </CardHeader>
      ...
      <Card>
        <CardHeader className="mb-4">
          ...
          <span className="text-sds-gray-400 text-xs">Last 30 days</span>
        </CardHeader>
        <DataTable
          columns={columns}
          data={topPages}
